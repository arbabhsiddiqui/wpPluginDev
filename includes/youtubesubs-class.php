...
/**
 * Adds Youtube_Sub_Widget widget.
 */
 class Youtube_Sub_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'youtubesub_widget', // Base ID
			esc_html__( 'Youtube Sub Counter', 'yts_domain' ), // Name
			array( 'description' => esc_html__( 'A Youtube_Sub Widget', 'yts_domain' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
        ...
        // show content
echo '<div class="g-ytsubscribe" data-channel="'.$instance['channel'].'" data-layout="'.$instance['layout'].'" data-count="'.$instance['count'].'"  data-theme="'.$instance['theme'].'"></div>';
		// echo esc_html__( 'get new plugin', 'yts_domain' );
	...
	public function form( $instance ) {
        $title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Youtube Sub Counter', 'yts_domain' );
        $channel = ! empty( $instance['channel'] ) ? $instance['channel'] : esc_html__( 'drazizkhan', 'yts_domain' );
...
<p>
        ...
        <p>
		<label 
        for="<?php echo esc_attr( $this->get_field_id( 'theme' ) ); ?>">
